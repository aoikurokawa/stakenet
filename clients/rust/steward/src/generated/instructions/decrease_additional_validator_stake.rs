...
impl DecreaseAdditionalValidatorStake {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DecreaseAdditionalValidatorStakeInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl DecreaseAdditionalValidatorStakeInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [90, 22, 113, 73, 21, 229, 33, 83],
        }
    }
}
...
///   2. `[writable]` validator_history
///   3. `[]` vote_account
///   4. `[]` stake_pool_program
///   5. `[]` stake_pool
///   6. `[]` withdraw_authority
///   7. `[writable]` validator_list
///   8. `[writable]` reserve_stake
///   9. `[writable]` stake_account
///   10. `[writable]` ephemeral_stake_account
///   11. `[writable]` transient_stake_account
///   12. `[]` clock
///   13. `[]` stake_history
///   14. `[optional]` system_program (default to `11111111111111111111111111111111`)
///   15. `[]` stake_program
///   16. `[writable, signer]` admin
...
impl DecreaseAdditionalValidatorStakeBuilder {
    ...
    #[inline(always)]
    pub fn ephemeral_stake_account(
        &mut self,
        ephemeral_stake_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn transient_seed(&mut self, transient_seed: u64) -> &mut Self {
        self.transient_seed = Some(transient_seed);
        self
    }
    #[inline(always)]
    pub fn ephemeral_seed(&mut self, ephemeral_seed: u64) -> &mut Self {
        self.ephemeral_seed = Some(ephemeral_seed);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DecreaseAdditionalValidatorStake {
            ...
            ephemeral_stake_account: self
                .ephemeral_stake_account
                .expect("ephemeral_stake_account is not set"),
        ...
        let args = DecreaseAdditionalValidatorStakeInstructionArgs {
            ...
            transient_seed: self
                .transient_seed
                .clone()
                .expect("transient_seed is not set"),
            ephemeral_seed: self
                .ephemeral_seed
                .clone()
                .expect("ephemeral_seed is not set"),
        };
...
impl<'a, 'b> DecreaseAdditionalValidatorStakeCpiBuilder<'a, 'b> {
    ...
    pub fn ephemeral_stake_account(
        &mut self,
        ephemeral_stake_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn transient_seed(&mut self, transient_seed: u64) -> &mut Self {
        self.instruction.transient_seed = Some(transient_seed);
        self
    }
    #[inline(always)]
    pub fn ephemeral_seed(&mut self, ephemeral_seed: u64) -> &mut Self {
        self.instruction.ephemeral_seed = Some(ephemeral_seed);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
