...
impl Idle {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = IdleInstructionData::new().try_to_vec().unwrap();
...
pub struct IdleInstructionData {
    discriminator: [u8; 8],
}

impl IdleInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [200, 79, 16, 41, 251, 91, 239, 83],
        }
    }
}

impl Default for IdleInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `Idle`.
///
/// ### Accounts:
///
///   0. `[]` config
...
/// `idle` CPI accounts.
pub struct IdleCpiAccounts<'a, 'b> {
...
/// `idle` CPI instruction.
pub struct IdleCpi<'a, 'b> {
...
impl<'a, 'b> IdleCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: IdleCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `Idle` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   2. `[]` validator_list
#[derive(Clone, Debug)]
pub struct IdleCpiBuilder<'a, 'b> {
    instruction: Box<IdleCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> IdleCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(IdleCpiBuilderInstruction {
            __program: program,
            config: None,
            state_account: None,
            validator_list: None,
...
#[derive(Clone, Debug)]
struct IdleCpiBuilderInstruction<'a, 'b> {
