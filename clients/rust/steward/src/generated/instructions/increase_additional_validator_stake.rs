...
impl IncreaseAdditionalValidatorStake {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = IncreaseAdditionalValidatorStakeInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl IncreaseAdditionalValidatorStakeInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [93, 136, 94, 230, 32, 54, 167, 242],
        }
    }
}
...
///   8. `[writable]` ephemeral_stake_account
