...
impl InstantRemoveValidator {
    pub fn instruction(
        &self,
        args: InstantRemoveValidatorInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InstantRemoveValidatorInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct InstantRemoveValidatorInstructionData {
    discriminator: [u8; 8],
}

impl InstantRemoveValidatorInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [119, 127, 216, 135, 24, 63, 229, 242],
        }
    }
}

impl Default for InstantRemoveValidatorInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct InstantRemoveValidatorInstructionArgs {
    pub validator_index_to_remove: u64,
}

/// Instruction builder for `InstantRemoveValidator`.
///
/// ### Accounts:
///
///   0. `[]` config
...
pub struct InstantRemoveValidatorBuilder {
...
impl InstantRemoveValidatorBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InstantRemoveValidator {
        ...
        let args = InstantRemoveValidatorInstructionArgs {
            validator_index_to_remove: self
                .validator_index_to_remove
                .clone()
                .expect("validator_index_to_remove is not set"),
        };
...
/// `instant_remove_validator` CPI accounts.
pub struct InstantRemoveValidatorCpiAccounts<'a, 'b> {
...
/// `instant_remove_validator` CPI instruction.
pub struct InstantRemoveValidatorCpi<'a, 'b> {
    ...
    pub __args: InstantRemoveValidatorInstructionArgs,
}

impl<'a, 'b> InstantRemoveValidatorCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InstantRemoveValidatorCpiAccounts<'a, 'b>,
        args: InstantRemoveValidatorInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InstantRemoveValidator` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   3. `[]` stake_pool
#[derive(Clone, Debug)]
pub struct InstantRemoveValidatorCpiBuilder<'a, 'b> {
    instruction: Box<InstantRemoveValidatorCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InstantRemoveValidatorCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InstantRemoveValidatorCpiBuilderInstruction {
            __program: program,
            config: None,
            state_account: None,
            validator_list: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InstantRemoveValidatorCpi {
...
#[derive(Clone, Debug)]
struct InstantRemoveValidatorCpiBuilderInstruction<'a, 'b> {
