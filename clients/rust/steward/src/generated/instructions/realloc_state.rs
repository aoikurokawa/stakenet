...
impl ReallocState {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ReallocStateInstructionData::new().try_to_vec().unwrap();
...
pub struct ReallocStateInstructionData {
    discriminator: [u8; 8],
}

impl ReallocStateInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ReallocStateInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ReallocState`.
///
/// ### Accounts:
///
...
pub struct ReallocStateBuilder {
...
/// `realloc_state` CPI accounts.
pub struct ReallocStateCpiAccounts<'a, 'b> {
...
/// `realloc_state` CPI instruction.
pub struct ReallocStateCpi<'a, 'b> {
...
impl<'a, 'b> ReallocStateCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ReallocStateCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ReallocState` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` state_account
...
///   4. `[writable, signer]` signer
#[derive(Clone, Debug)]
pub struct ReallocStateCpiBuilder<'a, 'b> {
    instruction: Box<ReallocStateCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReallocStateCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ReallocStateCpiBuilderInstruction {
            __program: program,
            state_account: None,
            config: None,
            validator_list: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ReallocStateCpi {
...
#[derive(Clone, Debug)]
struct ReallocStateCpiBuilderInstruction<'a, 'b> {
